 ...
 */
public class Criterios_Religador {
    
     public static void criterio_religador_fase_SALVAFUSIVEL( //RELÉ PRIMEIRO DA REDE FASE
            Circuito circ,
            ReleFF releff) {
        ...
        System.out.println("Curva LENTA de fase:");
        System.out.println("FM: " + escolhido_fm + " AT: " + escolhido_at + " AC: " + escolhido_ac);
        System.out.println("");
        
        // **************** C U R V A  R Á P I D A *********************
        //*** Possuem característica instantânea, não inversa ***
        
        System.out.println("Curva RÁPIDA de fase: AT deve ser pelo menos maior do que o tempo de inrush (0,1 s).");
        System.out.println("AC da curva de fase: "+escolhido_ac);
    }


 public static void criterio_religador_neutro_SALVAFUSIVEL( //corrigido, fazer mais testes.
           Circuito circ,
            ReleFN relefn) {
        ...
        System.out.println("Curva LENTA de neutro:");
        System.out.println("FM: " + escolhido_fm + " AT: " + escolhido_at + " AC: " + escolhido_ac);
        System.out.println("");
 ...
 public static void criterio_religador_fase_QUEIMAFUSIVEL( 
            Circuito circ,
            ReleFF releff) {
    ...
    public static void criterio_religador_neutro_QUEIMAFUSIVEL( //corrigido, fazer mais testes.
            Circuito circ,
            ReleFN relefn) {
