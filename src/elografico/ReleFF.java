...
public class ReleFF {
    double AT_lenta, AC_lenta, AT_rapida, AC_rapida, A_NI, B_NI, P_NI, A_MI, B_MI, P_MI, A_EI, B_EI, P_EI, deltaT, FM;
    ...
    public void setAT_lenta(double AT_lenta) {
        this.AT_lenta = AT_lenta;
    }
